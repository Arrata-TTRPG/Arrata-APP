...
pub(crate) fn CharacterIO() -> Element {
    rsx! {
        div { class: "px-5 py-5 font-mono origin-center justify-center text-center self-center items-center content-center flex flex-wrap gap-2",
            button {
            ...
            button {
                class: "font-mono text-xl bg-red-900 hover:bg-red-950 text-white font-bold py-2 px-4 rounded",
